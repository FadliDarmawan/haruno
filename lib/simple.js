 ...
 */
    ...
    */
     ...
     * @param {Object} options
     */
     async sendButtonVid(jid, buffer, content, footer, button1, row1, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
        ...
        headerType: 5,
        imageMessage: (await this.prepareMessageMedia(buffer, MessageType.video, {})).videoMessage
      }, MessageType.buttonsMessage, {
        quoted, ...options
      })
    }
    async send2ButtonVid(jid, buffer, content, footer, button1, row1, button2, row2, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    async send3ButtonVid(jid, buffer, content, footer, button1, row1, button2, row2, button3, row3, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
